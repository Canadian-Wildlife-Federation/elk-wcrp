...
#| label: table-8
#| tbl-cap: "Implementation plan for 2026-2027 to close knowledge gaps and advance barrier rehabilitation to improve connectivity for Westslope Cutthroat Trout in Qukin ?amak?is. Steps to incorporate field data, update models, and revise this WCRP are also included."
#| warning: false
#| echo: false
source("Rscripts/table_formatting.R")
library("flextable")

data <- read.csv("data/workplan.csv", check.names=FALSE)
ft <- flextable(data)
